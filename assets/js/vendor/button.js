$(function () {
  ...
  QUnit.test('should trigger input change event when toggled button has input field', function (assert) {
    ...
    var groupHTML = '<div class="btn-group" data-toggle="buttons">' +
      ...
      '</label>' +
      '</div>'
    var groupHTML2 = '<div class="group" data-toggle="buttons">' +
      '<label class="btn btn-secondary">' +
      '<input type="radio" id="radio" autocomplete="off">Radio' +
      '</label>' +
      '</div>'
    var $group = $(groupHTML).appendTo('#qunit-fixture')
    var $group2 = $(groupHTML2).appendTo('#qunit-fixture')
    ...
    $group2.find('input').on('change', function (e) {
      e.preventDefault()
      assert.ok(true, 'change event fired')
      done()
    })
    ...
    $group2.find('label').trigger('click')
  })
  ...
  QUnit.test('should check for closest matching toggle', function (assert) {
    ...
    var groupHTML = '<div class="btn-group" data-toggle="buttons">' +
      ...
      '</label>' +
      '</div>'
    var groupHTML2 = '<div class="btn-group" data-toggle="buttons">' +
    ...
    var $btn1 = $group2.children().eq(0)
    var $btn2 = $group.children().eq(1)
    var $btn2 = $group2.children().eq(1)
